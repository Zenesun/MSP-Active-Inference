...
def create_B_matrix():
  ...
  for action_id, action_label in enumerate(actions):
    ...
    for curr_state, grid_location in enumerate(grid_locations):
      ...
      new_location1 = (next_y1, next_x1)
      new_location2 = (next_y2, next_x2)
      next_state = grid_locations.index(new_location)
      next_state1 = grid_locations.index(new_location1)
      next_state2 = grid_locations.index(new_location2)

      if next_state != next_state1 and next_state != next_state2:
        B[next_state, curr_state, action_id] = 1/3
        B[next_state1, curr_state, action_id] = 1/3
        B[next_state2, curr_state, action_id] = 1/3
      elif next_state == next_state1 and next_state != next_state2:
        B[next_state, curr_state, action_id] = 2/3
        B[next_state2, curr_state, action_id] = 1/3
      elif next_state != next_state1 and next_state == next_state2:
        B[next_state, curr_state, action_id] = 2/3
        B[next_state1, curr_state, action_id] = 1/3
...
qs_final, reward = active_inference_with_planning(A, B, C, D, n_actions, env, policy_len = 2, T = 60)
